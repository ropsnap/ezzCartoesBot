...
function ccmix($message){
	...
	bot("editMessageText",array( "message_id" => $message['message_id'] , "chat_id"=> $chat_id , "text" => "Está area é resevada para os pacotes mix. Caso não tenha o mix que você procura, entre em contato com o vendedor: *{$confibot['userDono']}* \n $tabela \n","reply_markup" =>$menu,"reply_to_message_id"=> $message['message_id'],"parse_mode" => 'Markdown'));
